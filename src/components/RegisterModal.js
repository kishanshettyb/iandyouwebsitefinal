						...
						<Col xl={8} md={12} className="order-1 order-xl-2">
							<div className="payment-info ">
								...
								{/* <Form noValidate validated={validated} onSubmit={handleSubmit} className="position-relative">
									...
									<Row className="mb-3">
										<Form.Group as={Col} md="4" xs="6" controlId="validationCustom011">
											<Form.Label>
												Full Name<span className="text-danger">*</span>
											</Form.Label>
											<Form.Control required type="text" placeholder="Full name" />
										...
										<Form.Group as={Col} md="3" xs="6" controlId="validationCustom022">
											<Form.Label>
												Email<span className="text-danger">*</span>
											</Form.Label>
											<Form.Control required type="email" placeholder="Email" />
										...
										<Form.Group as={Col} md="3" xs="6" controlId="validationCustom033">
											<Form.Label>
												Phone<span className="text-danger">*</span>
											</Form.Label>
											<Form.Control required type="text" placeholder="Phone" />
										...
										<Form.Group as={Col} md="2" xs="6" controlId="validationCustom055">
											<Form.Label>
												Age<span className="text-danger">*</span>
											</Form.Label>
											<Form.Control required type="number" placeholder="Age" />
									...
									<Row className="mb-3">
										<Form.Group as={Col} md="3" xs="3" controlId="validationCustom044">
											<Form.Label>
												DOB<span className="text-danger">*</span>
											</Form.Label>
											<Form.Control required type="text" placeholder="Date of birth" />
										...
										<Form.Group as={Col} md="4" xs="3" controlId="validationCustom077">
											<Form.Label>
												Occupation<span className="text-danger">*</span>
											</Form.Label>
											<Form.Control required type="text" placeholder="Occupation" />
										...
										<Form.Group as={Col} md="5" xs="12" controlId="validationCustom066">
											<Form.Label>
												Gender<span className="text-danger">*</span>
											</Form.Label>
											<Form className="mt-2">
									...
									<Row className="mb-3">
										...
										<Form.Group as={Col} md="12" xs="12" controlId="validationCustom077">
											<Form>
												{["checkbox"].map((type) => (
													<div key={`inline-${type}`} className="mb-3">
														<Form.Check inline name="1" label="High B.P." type={type} id={`inline-${type}-1`} />
										...
										<Form.Group as={Col} md="6" xs="12" controlId="validationCustom055">
											<Form.Label>Other</Form.Label>
									...
									<Row className="mb-3">
										...
										<Form.Group as={Col} md="3" xs="6" controlId="validationCustom04">
											<Form.Label>State</Form.Label>
											<Form.Control type="text" placeholder="State" />
											<Form.Control.Feedback type="invalid">Please provide a valid state.</Form.Control.Feedback>
										</Form.Group>
										<Form.Group as={Col} md="3" xs="6" controlId="validationCustom05">
											<Form.Label>Zip</Form.Label>
											<Form.Control type="text" placeholder="Zip" />
											<Form.Control.Feedback type="invalid">Please provide a valid zip.</Form.Control.Feedback>
										</Form.Group>
