			...
			<section>
				<Container>
					...
					<p className="fw-bold">
						...
						weight loss, with no differences seen between people practicing two distinct styles of yoga. Recently published in the journal Obesity, the study was partially funded
						by the National Centre for Complementary and Integrative Health and led by researchers at the University of Pittsburgh, Duke University Medical Center, and University
						of Zurich
					</p>
					...
					<div className="quote">
						...
						<p className="desc font-philosopher">
							Reducing weight is a wrong saying and not healthy, say I want to maintain weight, when you start maintaining weight you will see drastic changes in your body, your
							mood will improve for good, brings you good health and a young body, all you need is to take care of your food, do hatha yoga along with Eshwari Kriya and Dhyana{" "}
						</p>
