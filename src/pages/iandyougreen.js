...
const iandyougreen = () => {
	return (
		<Layout>
			<Banner title="I And You Green" subTitle="" mainLink="Projects" link="Sri Krishi" />
			...
			<section className="bg-light">
				<Container>
					<Row className="d-flex align-items-center">
						...
						<Col md={6}>
							<p className="fw-bold">
								The seeds for the project were sown by Sri Prasad, founder of “I and You Being together foundation”, I and you green includes three separate projects they are
								namely{" "}
							</p>
							<ul className="regular-ul-list-none">
								<li>
									<span className="fw-bold">1. I AND YOU GREEN</span> - Neem Saplings plantation
								</li>

								<li>
									<span className="fw-bold">2. MINI FOREST FORMATIONS</span> - Bees & Birds attracting plants plantation
								</li>

								<li>
									<span className="fw-bold">3. SRI KRISHI</span> - Promotion and creating awareness about organic farming{" "}
								</li>
							</ul>
							<p className="desc font-philosopher">
								Inaugurated by <b>PADMA BHUSHAN KISAN BABURAO “ANNA” HAZARE</b>
							</p>
							<div className="quote">
								<StaticImage className="left" src="../images/icons/quote.png" alt="quote" />
								<StaticImage className="right" src="../images/icons/quote.png" alt="quote" />
