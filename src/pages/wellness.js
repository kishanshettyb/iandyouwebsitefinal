			...
			<section>
				<Container>
					...
					<p className="fw-bold mb-4">
						The World Health Organization has recognized the role of spirituality as that which brings you a sense of satisfaction, wellness, connectivity, and confidence in
						whatever you do
					</p>
					<div className="quote">
