					...
					<Row className="d-flex align-items-center">
						<Col md={6}>
							...
							<p>
								...
								resting state of the brain regular practice of Eshwari Dhyana can result in a state of cosmic consciousness, in which the experience of transcendence is always
								present in one's awareness, even during activity, with greater clarity and focus, One comes to experience one's self as universal and omnipresent. One's identity
								shifts from the individual to the cosmic. Eshwari Dhyana is a simple , effortless yet effective Shaktha method
							</p>
						</Col>
						<Col md={6}></Col>
					</Row>
