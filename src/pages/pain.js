			...
			<section>
				<Container>
					...
					<div className="quote">
						...
						<p className="desc font-philosopher">
							More over one should take care of intake meaning food, if the food produces more acid then the muscles, joints and back will start paining, giving exercise to the
							body and proper diet along with Eshwari Kriya and Dhyana will help you manage Pain
						</p>
