...
const harmones = () => {
	return (
		<Layout>
			<Banner title="Harmones" subTitle="Effect on Harmones" mainLink="Eshwari Kriya" link="Harmones" />
			<Container>
				...
				<p>
					It offers a holistic approach, addressing physical, mental, and emotional aspects of well-being. By embracing the simplicity and effectiveness of EK, individuals can take
					wise steps toward achieving hormonal balance and overall health.
				</p>
