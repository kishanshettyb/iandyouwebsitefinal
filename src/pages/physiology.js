	...
	return (
		<Layout>
			...
			<Container>
				...
				<p>
					Following is some of the physical benefits of yoga that have a growing body of research behind them. In addition to the conditions listed below, preliminary research also
					shows that yoga may help with migraines, osteoporosis, balance and mobility issues, multiple sclerosis, inflammatory bowel disease, fibromyalgia, and ADHD.
				</p>
				<ul>
